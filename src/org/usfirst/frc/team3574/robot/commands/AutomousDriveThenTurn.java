 ...
 *
 */
public class AutomousDriveThenTurn extends Command {
    ...
    public AutomousDriveThenTurn(double xSpeed, double ySpeed, double amountToRotate, int distance) {
